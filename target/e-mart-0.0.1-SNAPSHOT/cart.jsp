...
<div class="d-flex py-3">
    ...
    <a class="mx-3 btn btn-primary" href="cart-check-out">Confirm Order</a>
    <a class="mx-3 btn btn-success" target="_blank" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=XCJZWJJU77KGY">Pay with PayPal</a>
</div>		<table class="table table-light">
			<thead>
				<tr>
